...
SAVE = False
DISCORD_URL = "https://discordapp.com/api/webhooks/717702428710928394/iztOVHclKXh28PV3nnhYeXKiUoGjq5_vE1tKP-95zBTRJNNoyDWhazrU-67AtI9vheIA"
...
def get_bios(user_id, API):
    ...
    embed.set_footer(text='Powered by JINGXUAN#3229')
